...
export declare interface ChatboxOptions {
     ...
     *
     * See {@link MessageFilter} for all available options.
     *
...
export declare interface ConversationBuilder {
    ...
    setAttributes(attributes: Partial<ConversationAttributes>): void;
    /**
     * Sends a text message in a given conversation.
     * @param text The message body that is to be sent.
     * @param custom An object with any custom data that you may wish to associate with this message. The custom data is sent back to you via webhooks and the REST API.
     */
 ...
 */
/** @public */
export declare interface ConversationFilter {
    /**
...
/**
 * @public
 * @hidden from the docs until we fix the bug that makes this cause sdkdocgen to stack overflow :D
 */
...
export declare interface Inbox extends UIBox {
     ...
     *
     * See {@link ConversationFilter} for all available options.
     *
...
export declare class Session {
     ...
     * wrong. If anything goes wrong, the promise will be rejected with a Talk.Error`, which has a
     * `code` property. Possible values for it are:
     *
     * - `Talk.Error.Code.NOTIFICATIONS_PERMISSION_DENIED`: The browser or the user didn't grant you
     *   permission to send notifications.
     * - `Talk.Error.Code.NOTIFICATIONS_NOT_SUPPORTED`: The browser doesn't support desktop
     *   notifications.
     */
